      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="/<?php echo base_url();?>Admin-Doctorschedule" class="nav-link">
              <i class="nav-icon fas fa-chart-pie"></i>
              <p> Doctor Time Schedule</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/<?php echo base_url();?>Admin-AddPatients" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Patient</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/<?php echo base_url();?>Admin-PatientsList" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Patients List</p>
                </a>
              </li>
