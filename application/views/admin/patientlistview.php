          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Search Patients Lists  </h3>
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="patienttable" class="table table-bordered table-hover display responsive nowrap" style="width:100%">
                </table>
...
?>
<script src="/<?php echo base_url();?>assets/backend/js/PatientController.js"></script>
